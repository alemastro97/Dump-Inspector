...
/**
 * Servlet implementation class GetAllAnnotation
 */
@WebServlet("/GetAllUserAnnotation")
public class GetAllUserAnnotation extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	    ...
	    ArrayList<Annotazione> a = aDao.findUserOnAnnotation(idImmagine);
	    Gson gson = new Gson();
