...
public class CheckCredenziali extends HttpServlet {
    ...
    public void init() throws ServletException{
		...
		protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
			...
			if(((Utente) (request.getSession().getAttribute("account"))).getUsername().equals(username)) b_username = false;
			else b_username = uDao.usernamePresente(username);
			
			if(((Utente) (request.getSession().getAttribute("account"))).getEmail().equals(email)) b_email = false;
			else b_email = uDao.emailPresente(email);
